...
const ContactForm = () => {
  ...
  return (
    <div id="contact">
      <section className="text-gray-700 body-font relative dark:bg-gray-950">
        <div className="container px-5 py-24 mx-auto">
          <div className="flex flex-col text-center w-full mb-12">
            <p className="sm:text-3xl text-2xl font-medium title-font mb-4 text-gray-900 dark:text-gray-300">
              Contactez moi ! 🚀
            </p>
