...
const ServiceCard = ({ title, description, icon }: ServiceCardProps) => {
  return (
    <div className="p-5 sm:p-6 lg:p-8 rounded-3xl border border-gray-200 dark:border-gray-800 bg-gray-100 dark:bg-gray-100 relative overflow-hidden">
      <div className="rounded-xl bg-gray-200 dark:bg-gray-800 p-3 text-gray-900 dark:text-white w-max relative">
        {iconRender(icon)}
      </div>
      <div className="mt-6 space-y-4 relative">
        <h2 className="text-lg md:text-xl font-semibold text-gray-900 dark:text-gray-950">
          {title}
        </h2>
        <p className="text-gray-700 dark:text-gray-950">{description}</p>
      </div>
